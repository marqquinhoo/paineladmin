...
<head>
  ...
  <script>
    ...
    function redireciona(id){
        window.location.href = '<?php echo base_url();?>painel/fornecedoresdet/'+id+'';           
    }
    ...
    function salvar(){
        var fornecedor = document.getElementById("fornecedor").value;
            ...
            $.ajax({                
                url : '<?php echo base_url();?>painel/cadfornecedores',
                dataType : 'html',
                type : 'POST',
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#novoFornecedor">Novo</button></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $forn['total'];?></td>
                  <td><button type="button" class="btn btn-outline-primary btn-sm" onclick="redireciona(<?php echo $forn['id'];?>)">Detalhes</button></td>
                </tr>
                <?php endforeach;?>
                </tbody>
                <tfoot>
  ...
  $(function () {
    ...
    $('#example2').DataTable({
      ...
      "autoWidth": false,
            ...
            <div class="modal fade" id="novoFornecedor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                  ...
                  <div class="modal-body">
                      <input type="text" class="form-control" name="fornecedor" id="fornecedor" value="">
                  </div>
