...
<head>
  ...
  <script>
    ...
    function novo(){
        window.location.href = '<?php echo base_url();?>painel/produtosn';         
    }

    function redireciona(id){
        window.location.href = '<?php echo base_url();?>painel/produtosdet/'+id+'';           
    }
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><button type="button" class="btn btn-outline-primary btn-sm" onclick="novo()">Novo</button></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>
                      <img src="<?php echo base_url();?>/uploads/<?php echo $prod['foto'];?>" width="50px" height="50px">
                  </td>
                  <td><?php echo $prod['codigo'];?></td>
                  <td><?php echo $prod['nome'];?></td>
                  <td><?php echo $prod['categoria'];?></td>
                  <td><?php echo $prod['valor'];?></td>
                  <td><?php echo $prod['desconto'];?></td>
                  <td><?php echo $prod['destaque'];?></td>
                  <td <?php echo $style;?>><?php echo $prod['estoque'];?></td>
                  <td><button type="button" class="btn btn-outline-primary btn-sm" onclick="redireciona(<?php echo $prod['id'];?>)">Detalhes</button></td>
                </tr>
                <?php endforeach;?>
                </tbody>
                <tfoot>
